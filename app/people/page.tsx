...
export default function PeoplePage() {
  ...
  return <PageFrame>
    <section className="section-shell pi-profile people-profile-first">
      ...
      <dl className="profile-facts"><div><dt>2022–present</dt><dd>Assistant Professor, Dong Seoul University<ul className="career-subitems"><li>Department Chair, Department of Electronic Engineering (since 2025)</li></ul></dd></div><div><dt>2014–2022</dt><dd>Senior Researcher, Agency for Defense Development</dd></div><div><dt>2015</dt><dd>IMA Design Technology Training, Airbus Helicopters, Marignane, France<ul className="career-subitems"><li>April–June 2015 · Integrated Modular Avionics (IMA)</li></ul></dd></div><div><dt>2014</dt><dd>Ph.D., Electrical & Electronic Engineering, Yonsei University</dd></div><div><dt>2007</dt><dd>B.S., Electrical &amp; Electronic Engineering, Yonsei University</dd></div></dl>
    </section>
