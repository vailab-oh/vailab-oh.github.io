...
export default function PeoplePage() {
  ...
  return <PageFrame>
    <section className="section-shell pi-profile people-profile-first">
      ...
      <div className="profile-copy"><p className="eyebrow">Principal investigator · 지도교수</p><h2>Taegeun Oh <span lang="ko">(오태근)</span>, Ph.D.</h2><p className="profile-role">Assistant Professor · Department of Electronic Engineering<br />Dong Seoul University · 동서울대학교 전자공학과</p><p>Taegeun Oh works across autonomous mission software, intelligent path planning, computer vision, and medical image intelligence. Before joining Dong Seoul University in 2022, he spent eight years as a senior researcher at the Agency for Defense Development, developing avionics and autonomy for unmanned aerial systems.</p><p className="profile-training">Professional experience includes IMA design technology training at Airbus Helicopters in Marignane, France (2015).</p><ProfileLinks /></div>
      <dl className="profile-facts"><div><dt>2022–present</dt><dd>Assistant Professor, Dong Seoul University<ul className="career-subitems"><li>Department Chair, Department of Electronic Engineering (since 2025)</li></ul></dd></div><div><dt>2014–2022</dt><dd>Senior Researcher, Agency for Defense Development</dd></div><div><dt>2014</dt><dd>Ph.D., Electrical & Electronic Engineering, Yonsei University</dd></div><div><dt>2007</dt><dd>B.S., Electrical &amp; Electronic Engineering, Yonsei University</dd></div></dl>
    </section>
