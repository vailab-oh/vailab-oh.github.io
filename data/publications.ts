 ...
 * homepage highlights all update automatically. Set `date` to the publication
 * date (YYYY-MM-DD); the Publications page and home-page preview sort by it.
 * Add `url` only for an official
...
export type Publication = {
  id: string;
  /** Publication date in YYYY-MM-DD format; never use file timestamps. */
  date: string;
  year: number;
...
export const publications: Publication[] = [
  {
    id: "oh-time-window-uav", date: "2026-01-01", year: 2026, type: "journal", status: "Submitted",
    authors: "Taegeun Oh",
  ...
  {
    id: "jang-xgate-net", date: "2026-01-01", year: 2026, type: "journal", status: "Submitted",
  ...
  {
    id: "jang-triv-net", date: "2026-01-01", year: 2026, type: "journal", status: "Major revision",
  ...
  {
    id: "choi-multi-organ", date: "2026-06-01", year: 2026, type: "journal", status: "Published",
  ...
  {
    id: "choi-rabbit-brain", date: "2026-01-01", year: 2026, type: "journal", status: "Published",
  ...
  {
    id: "oh-ta-rrt", date: "2025-02-01", year: 2025, type: "journal", status: "Published",
  ...
  {
    id: "jung-delivery-robot", date: "2024-01-01", year: 2024, type: "conference", status: "Published",
  ...
  {
    id: "kwon-anger-gait", date: "2023-04-01", year: 2023, type: "domestic", status: "Published",
  ...
  {
    id: "oh-mobility-path-planning-book", date: "2023-01-01", year: 2023, type: "book", status: "Published",
    authors: "Taegeun Oh",
  ...
  {
    id: "oh-flight-control-fault", date: "2022-05-01", year: 2022, type: "journal", status: "Published",
  ...
  {
    id: "chang-autonomous-mission", date: "2021-06-01", year: 2021, type: "journal", status: "Published",
  ...
  {
    id: "kim-autonomous-awareness", date: "2021-04-01", year: 2021, type: "domestic", status: "Published",
  ...
  {
    id: "han-pilot-mental-state", date: "2020-01-01", year: 2020, type: "journal", status: "Published",
  ...
  {
    id: "kim-uhd-sharpness", date: "2017-05-01", year: 2017, type: "journal", status: "Published",
  ...
  {
    id: "oh-comic-fingerprint", date: "2015-11-01", year: 2015, type: "journal", status: "Published",
  ...
  {
    id: "oh-blind-sharpness-motion", date: "2015-03-01", year: 2015, type: "journal", status: "Published",
  ...
  {
    id: "oh-camera-shaken", date: "2014-12-01", year: 2014, type: "journal", status: "Published",
  ...
  {
    id: "oh-video-multicast", date: "2014-10-01", year: 2014, type: "journal", status: "Published",
    authors: "Taegeun Oh and Sanghoon Lee",
  ...
  {
    id: "oh-assessing-motion-blur", date: "2014-01-01", year: 2014, type: "conference", status: "Published",
  ...
  {
    id: "kang-comic-identification", date: "2014-02-01", year: 2014, type: "conference", status: "Published",
  ...
  {
    id: "kim-copyright-comics", date: "2014-02-01", year: 2014, type: "conference", status: "Published",
  ...
  {
    id: "lee-visual-sensor-network", date: "2014-05-01", year: 2014, type: "domestic", status: "Published",
  ...
  {
    id: "oh-dynamic-bandwidth", date: "2013-04-01", year: 2013, type: "journal", status: "Published",
  ...
  {
    id: "lee-device-aware", date: "2013-12-01", year: 2013, type: "journal", status: "Published",
  ...
  {
    id: "kim-stereoscopic-discomfort", date: "2013-10-01", year: 2013, type: "conference", status: "Published",
  ...
  {
    id: "oh-block-truncation", date: "2012-05-01", year: 2012, type: "journal", status: "Published",
    authors: "Taegeun Oh and Sanghoon Lee",
  ...
  {
    id: "oh-throughput-qos", date: "2009-01-01", year: 2009, type: "journal", status: "Published",
  ...
  {
    id: "ha-macroblock-weighting", date: "2009-09-01", year: 2009, type: "journal", status: "Published",
  ...
  {
    id: "park-power-allocation", date: "2009-11-01", year: 2009, type: "conference", status: "Published",
  ...
  {
    id: "oh-link-capacity", date: "2008-05-01", year: 2008, type: "conference", status: "Published",
    authors: "Taegeun Oh, Sanghoon Lee, and Gye-Tae Gil",
...
export const publishedPublications = publications
...
export const latestPublications = publishedPublications.slice(0, 3);
